...
$facultyId=$_POST['facultyId'];
  $dateCreated = date("Y-m-d");
    ...
    if($ret > 0){
      ...
      // Use prepared statement to insert student
      $stmt = mysqli_prepare($con, "INSERT INTO tblstudent(firstName,lastName,otherName,matricNo,password,levelId,facultyId,departmentId,sessionId,dateCreated) VALUES(?,?,?,?,'codeastro',?,?,?,?,?)");
      mysqli_stmt_bind_param($stmt, "ssssiiii", $firstname, $lastname, $othername, $matricNo, $levelId, $facultyId, $departmentId, $sessionId, $dateCreated);
